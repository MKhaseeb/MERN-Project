...
const Homecomponent = () => {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-6xl w-full flex flex-col md:flex-row items-center justify-between">
          <div className="md:w-1/2 w-full p-4 text-center md:text-left">
            ...
            <div className="flex gap-6 justify-center md:justify-start">
              ...
              <a
                href="/login"
                className="border border-blue-600 text-blue-600 hover:bg-blue-700 hover:text-white px-6 py-3 rounded-md font-semibold"
              >
                Explore Jobs
              </a>
            </div>
      ...
      {/* Scroll-triggered Sentences Over Video */}
      <section
        ref={sectionRef}
        id="section2"
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl w-full text-center">
          ...
          <div className="mt-16 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="/login"
              className="px-8 py-4 bg-teal-500 hover:bg-teal-600 text-white font-semibold text-lg rounded-xl shadow-md transition duration-300"
            >
              Get Started
            </a>
          </div>
      ...
      <footer className="bg-gradient-to-t from-[#0b0b0b] via-[#101010] to-gray-900 text-gray-400 px-6 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                Email: <span className="text-gray-300">support@jobplus.ai</span>
              </li>
              <li>
                Location: <span className="text-gray-300">Ramallah, Palestine</span>
              </li>
            </ul>
          </div>
        </div>
